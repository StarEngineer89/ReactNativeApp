...
import { StyleSheet, ImageURISource, ViewStyle, TouchableOpacity } from 'react-native';
...
const GridListItem = ({ uploading = false, ...props }: GridItemProps) => {
  ...
  return (
    <TouchableOpacity onPress={props.onPress} style={styles.item}>
      <HStack>
        <Image uri={props.uri} defaultSource={props.defaultSource} style={[styles.leftView]} imgStyle={[styles.leftView]} uploading={uploading} />
