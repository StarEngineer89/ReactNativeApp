...
const SelectList = ({ data, selected, setSelected, navigateBack, navigation }) => {
          ...
          return (
            ...
            >
              <VStack style={{ flex: 1, paddingHorizontal: 10 }}>
                <Spacer />
                <HStack>
                  <Text numOfLines={2} style={styles.textStyle}>
                    {item.name}
                  </Text>
                  <Spacer />
