...
const IMAGE_SIZE = Platform.isPad ? 240 : 200;
const IMAGE_BORDER = Platform.isPad ? 35 : 25;

const PageItem = ({ category, translateX, index }) => {
  ...
  return (
    <View style={[styles.pageStyle, { width }]}>
      <Animated.Image
        ...
        style={[styles.imageStyle, { marginBottom: isLandscape ? 60 : IMAGE_SIZE * 0.3 }, rImage]}
      />
    </View>
  );
};
