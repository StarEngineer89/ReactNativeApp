...
import { StyleSheet, Platform, Pressable, Easing } from 'react-native';
...
export const HeaderBackButton = () => (
  <Pressable onPress={() => navigationRef.current.goBack()} style={styles.backBtnContainer}>
    <Svg width={Platform.isPad ? 21.32 : 10.658} height={Platform.isPad ? 36.2 : 18.099} viewBox='0 0 10.658 18.099'>
      <Path
...
export const HomeHeaderRight = () => (
  <GearButton onPress={() => navigationRef.current.dispatch(DrawerActions.toggleDrawer())} />
);
...
export const VScreenOptions = {
  ...
  headerLeftContainerStyle: {
    marginLeft: Platform.isPad ? 32 : 18,
  },
...
export const EasingCardTransition = {
  transitionSpec: {
