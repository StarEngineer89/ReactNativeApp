...
const ResetPasswordScreen = () => {
  ...
  return (
    <>
      ...
      {state.reset.completed && <InfoModal body={'A Reset Link is sent to your email'} clearAction={clearReset} />}
        ...
        <Formik
          ...
          {({ handleSubmit, handleChange, values }) => (
            <VStack spacing={8}>
              ...
              <Button variant="gradient" onPress={() => handleSubmit()} title="Reset Password" />
            </VStack>
          )}
        </Formik>
      </AuthFormContainer>
