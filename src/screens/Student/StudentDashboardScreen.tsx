...
import { GridListItem, HomeHeaderView, ProgressLineBar } from 'components/custom';
...
interface Props
  extends CompositeScreenProps<
    NativeStackScreenProps<IStudentMainStackNavigatorParamsList, STUDENT.DASHBOARD>,
