  ...
  return (
    <ContainerView>
      ...
      <VStack spacing={15} style={{ marginTop: 20 }}>
        <LabelTextInput label="Enter Current Password" placeholder="Old Password" value={oldPassword} onChangeText={setoldPassword} secureTextEntry />
        <LabelTextInput label="Enter New Password" placeholder="New Password" value={newPassword} onChangeText={setnewPassword} secureTextEntry />
