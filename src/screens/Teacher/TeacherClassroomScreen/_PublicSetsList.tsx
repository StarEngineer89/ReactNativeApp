...
const PublicSetsList = (props: Props) => {
  return props.showList ? (
    <VStack alignment="leading" style={{ paddingBottom: StyleGuide.sizes.padding }}>
      <HStack alignment="leading" style={{ paddingHorizontal: StyleGuide.sizes.padding }}>
        <Text style={[StyleGuide.typography.dashboardHeader]}>Public Sets</Text>
        <Spacer />
        {props.showEdit && (
